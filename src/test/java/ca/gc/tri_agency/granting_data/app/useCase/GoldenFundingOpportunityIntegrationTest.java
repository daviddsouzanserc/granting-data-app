...
//    @WithMockUser(roles = { "NSERC_USER", "SSHRC_USER", "AGENCY_USER" })
    ...
    public void test_NonAdminCannotCreateGoldenFo_shouldFailWith403() throws Exception {
         ...
         System.out.println(foRepo.count());
        ...
        // ModelAndView mav = adminController.
        Model gfoModel = new BindingAwareModelMap();
        gfoModel.addAttribute(gfo);
        System.out.println(gfoModel);
        // BindingResult bindingResult = new
        String successUrl = mFoController.addFoPost(gfo, null, gfoModel);
